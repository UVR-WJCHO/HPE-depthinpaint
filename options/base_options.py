...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='pix2pix', help='chooses which model to use. [newpix2pix | pix2pix ]')
        parser.add_argument('--netG', type=str, default='unet_256_update', help='specify generator architecture [ unet_256_update | unet_256 | other | resnet_9blocks | resnet_6blocks]')
