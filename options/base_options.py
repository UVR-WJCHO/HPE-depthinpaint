...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', type=str, default='D:\Research_2020\PyTorch-CycleGAN\datasets\HO2H', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
