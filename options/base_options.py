...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # D:\Research_2020\PyTorch-CycleGAN\datasets\HO2H
        ...
        parser.add_argument('--netG', type=str, default='other', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 | other]')

        parser.add_argument('--n_layers_D', type=int, default=6, help='only used if netD==n_layers')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='inpaint', help='chooses how datasets are loaded. [inpaint | unaligned | aligned | single | colorization]')
